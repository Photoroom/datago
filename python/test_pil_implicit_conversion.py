...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    if sample:
        ...
        try:
            ...
            size = pil_image.size
            print(
                f"✓ Callable approach works: {type(pil_image)} - mode={mode}, size={size}"
            )
        except Exception as e:
        ...
        print("\n=== Summary ===")
        print(
            "The PythonImagePayload object provides multiple ways to access the PIL image:"
        )
        ...
        print(
            "3. Python dataset code can automatically call sample.image() for seamless experience"
        )
    else:
